 ...
 * date:2018-09-29
 */
public class AddCommentType12ChildAsynCall extends AbstractAsynCall<Integer> {

    private static final String URL = "base";

    @Inject
    public AddCommentType12ChildAsynCall(){}

    @Override
    public Observable<Integer> call(AsynParams params) {
        String rid = params.get("id");
		String content = params.get("content");
		String userid = AccountHelper.getInstance().getUserId();
		//业务逻辑
        return http().call(VideoApi.class, URL)
                .addCommentType12Child(rid, content, userid, Resource.API.STID, Resource.API.SIGN)
