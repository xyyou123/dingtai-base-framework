 ...
 * date:2018-09-14
 */
public class AddSubGoodPointAsynCall extends AbstractAsynCall<Boolean> {

    private static final String URL = "base";

    @Inject
    public AddSubGoodPointAsynCall(){}
    ...
    public Observable<Boolean> call(AsynParams params) {
        ...
        return http().call(NewsApi.class, URL)
                .addSubGoodPoint(Cid, Resource.API.STID, Resource.API.SIGN)
