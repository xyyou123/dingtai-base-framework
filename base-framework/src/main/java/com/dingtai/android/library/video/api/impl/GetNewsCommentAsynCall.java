 ...
 * date:2018-09-03
 */
public class GetNewsCommentAsynCall extends AbstractAsynCall<List<LiveCommentModel>> {

    private static final String URL = "base";

    @Inject
    public GetNewsCommentAsynCall(){}
    ...
    public Observable<List<LiveCommentModel>> call(AsynParams params) {
        ...
        return http().call(VideoApi.class, URL)
                .GetNewsComment(LiveID, Num, dtop, TabCode, Resource.API.STID, Resource.API.SIGN)
                ...
                .map(new Function<JSONObject, List<LiveCommentModel>>() {
                    ...
                    public List<LiveCommentModel> apply(JSONObject object) throws Exception {
                        return JsonUtil.parseArray(object.getString("LiveCommentList"), LiveCommentModel.class);
                    }
                })
