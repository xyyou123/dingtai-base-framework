 ...
 * date:2018-08-30
 */
public class GetLiveByTypeNewAsynCall extends AbstractAsynCall<List<LiveChannelModel>> {

    private static final String URL = "base";

    @Inject
    public GetLiveByTypeNewAsynCall(){}
    ...
    public Observable<List<LiveChannelModel>> call(AsynParams params) {
        ...
        return http().call(VideoApi.class, URL)
                .GetLiveByTypeNew(type, top, dtop, Resource.API.STID, Resource.API.SIGN)
