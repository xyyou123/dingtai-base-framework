 ...
 * date:2018-09-29
 */
public class AddCommentType34AsynCall extends AbstractAsynCall<Integer> {

    private static final String URL = "base";

    @Inject
    public AddCommentType34AsynCall(){}
    ...
    public Observable<Integer> call(AsynParams params) {
        ...
        return http().call(VideoApi.class, URL)
                .addCommentType34(LiveID, content, userid, Resource.API.STID, Resource.API.SIGN)
