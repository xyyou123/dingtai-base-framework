 ...
 * date:2019-03-14
 */
public class GetPersionShortVideoListAsynCall extends AbstractAsynCall<List<ShortVideoModel>> {

    private static final String URL = "base";

    @Inject
    public GetPersionShortVideoListAsynCall() {
    }
    ...
    public Observable<List<ShortVideoModel>> call(AsynParams params) {
        ...
        return http().call(VideoApi.class, URL)
                .getPersionShortVideoList(userGUID, num, dtop, StID)
