...
public class RingProgressBar extends View {
  ...
  public RingProgressBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    ringColor = mTypedArray.getColor(R.styleable.RingProgressBar_ringColor, Color.WHITE);
    ...
    textIsShow = mTypedArray.getBoolean(R.styleable.RingProgressBar_textIsShow, false);
    style = mTypedArray.getInt(R.styleable.RingProgressBar_style, 1);
