...
public class WheelView extends View {
    ...
    public void setTextPadding(int textPadding) {
        this.textPadding = DimenUtil.dp2px(getContext(), textPadding);
    }
    ...
    private void remeasure() {
        ...
        if (useWeight) {
            ...
            if (textPadding < 0) {
                textPadding = DimenUtil.dp2px(getContext(), ITEM_PADDING);
            }
    ...
    private void measuredCenterContentStart(String content) {
        ...
        switch (gravity) {
            case Gravity.CENTER://显示内容居中
                ...
                break;
            case Gravity.LEFT:
                drawCenterContentStart = DimenUtil.dp2px(getContext(), 8);
                break;
    ...
    private void measuredOutContentStart(String content) {
        ...
        switch (gravity) {
            case Gravity.CENTER:
                ...
                break;
            case Gravity.LEFT:
                drawOutContentStart = DimenUtil.dp2px(getContext(), 8);
                break;
            case Gravity.RIGHT:
