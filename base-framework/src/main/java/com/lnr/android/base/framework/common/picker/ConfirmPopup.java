...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    protected int contentLeftAndRightPadding = 20;//dp
    protected int contentTopAndBottomPadding = 12;//dp
    ...
    protected final View makeContentView() {
        ...
        if (contentLeftAndRightPadding > 0) {
            lr = DimenUtil.dp2px(activity, contentLeftAndRightPadding);
        }
        if (contentTopAndBottomPadding > 0) {
            tb = DimenUtil.dp2px(activity, contentTopAndBottomPadding);
        }
    ...
    protected View makeHeaderView() {
        ...
        int height = DimenUtil.dp2px(activity, topHeight);
        ...
        int padding = DimenUtil.dp2px(activity, topPadding);
        cancelButton.setPadding(padding, 0, padding, 0);
        if (!TextUtils.isEmpty(cancelText)) {
            cancelButton.setText(cancelText);
        }
        cancelButton.setTextColor(toColorStateList(cancelTextColor, pressedTextColor));
        if (cancelTextSize != 0) {
        ...
        if (null == titleView) {
            ...
            int margin = DimenUtil.dp2px(activity, topPadding);
        ...
        submitButton.setTextColor(toColorStateList(submitTextColor, pressedTextColor));
        if (submitTextSize != 0) {
     ...
     */
    public ColorStateList toColorStateList(@ColorInt int normalColor, @ColorInt int pressedColor,
