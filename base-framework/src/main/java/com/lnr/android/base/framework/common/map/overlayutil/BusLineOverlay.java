package com.lnr.android.base.framework.common.map.overlayutil;
...
public class BusLineOverlay extends OverlayManager {
    ...
    public final List<OverlayOptions> getOverlayOptions() {
        ...
        for (RouteNode station : mBusLineResult.getStations()) {
        ...
        for (RouteStep step : mBusLineResult.getSteps()) {
