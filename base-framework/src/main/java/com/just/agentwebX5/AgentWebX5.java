...
public class AgentWebX5 {
    ...
    private void goInit(String object) {
        IndicatorController mIndicatorController = null;
        if (!TextUtils.isEmpty(object) && (mIndicatorController = getIndicatorController()) != null && mIndicatorController.offerIndicator() != null) {
    ...
    private AgentWebX5 go(String data, String mimeType, String encoding) {
        goInit(data);
        this.getLoader().loadData(data, mimeType, encoding);
        return this;
    }
    ...
    public static class PreAgentWeb {
        ...
        public AgentWebX5 go(String data, String mimeType, String encoding) {
            if (!isReady) {
                ready();
            }
            return mAgentWebX5.go(data, mimeType, encoding);
        }
